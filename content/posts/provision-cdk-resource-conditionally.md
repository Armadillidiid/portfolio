...
Values that aren’t known during synthesis are represented as a [token](https://docs.aws.amazon.com/cdk/v2/guide/tokens.html), and these tokens during synthesis are placeholder strings (e.g., `${TOKEN[Bucket.Name.1234]}`) to be later substituted.
