---
title: A better way to deploy to EC2
date: 2026-01-27T09:09:08.763Z
tags:
  - aws
  - devops
  - ci-cd
cover: covers/a-better-way-to-deploy-to-ec2.png
---
...
That's why today we're going to look at [CodeBuild](https://docs.aws.amazon.com/codebuild/latest/userguide/welcome.html), [CodeDeploy](https://docs.aws.amazon.com/codedeploy/latest/userguide/welcome.html) and [CodePipeline](https://docs.aws.amazon.com/codepipeline/latest/userguide/welcome.html) and how to utilize them to better roll out your updates.

If you want to see the final result, check out the [GitHub repo](https://github.com/Armadillidiid/ec2-codepipeline-build-deploy).

## CI/CD Overview

In a typical CI/CD workflow, we can usually map it into 3 stages:

![](a-better-way-to-deploy-to-ec2/content/8a5c6075.png)
...
%[https://gist.github.com/Armadillidiid/e2c216487ffcaa92bb385eb8f0934a8b]
